...
fPath = r'D:\37379_20210104_imec0_ks25'
os.chdir(fPath)
import params

spike_times = np.load(fPath+ r'\spike_times.npy')
spike_clusters = np.load(fPath+ r'\spike_clusters.npy')
spike_templates = np.load(fPath+ r'\spike_templates.npy')
amplitudes = np.load(fPath+ r'\amplitudes.npy')
channel_map = np.load(fPath+ r'\channel_map.npy')
pc_features = np.load(fPath+ r'\pc_features.npy')
pc_feature_ind = np.load(fPath+ r'\pc_feature_ind.npy')
